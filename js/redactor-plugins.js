...
RedactorPlugins.fontfamily = function()
{
	return {
		init: function ()
		{
			...
			var button = this.button.add('fontfamily', __('Change Font Family'));
...
RedactorPlugins.textdirection = function()
{
	return {
		init: function()
		{
			...
			dropdown.ltr = { title: __('Left to Right'), func: that.textdirection.setLtr };
			dropdown.rtl = { title: __('Right to Left'), func: that.textdirection.setRtl};
