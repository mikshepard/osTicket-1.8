...
$dispatcher = patterns('',
    ...
    url('^/tickets/', patterns('ajax.tickets.php:TicketsAjaxAPI',
        ...
        url('^(?P<tid>\d+)/tasks/add-set$', 'addTaskGroupToTicket'),
    ...
    url('^/tasks/', patterns('ajax.tasks.php:TasksAjaxAPI',
        ...
        url('^(?P<tid>\d+)/cancel', 'cancel'),
        url('^(?P<tid>\d+)/start', 'start'),
        url_get('^(?P<tid>\d+)/view$', 'task'),
        url_post('^(?P<tid>\d+)$', 'task'),
        url('^add$', 'add'),
        url('^lookup', 'lookup'),
        url('^mass/(?P<action>\w+)(?:/(?P<what>\w+))?', 'massProcess'),
        url('^template/', patterns('ajax.tasks.php:TasksAjaxAPI',
            url('^group/add$', 'addTemplateGroup'),
            url('^group/(?P<id>\d+)$', 'editTemplateGroup')
        ))
    )),
