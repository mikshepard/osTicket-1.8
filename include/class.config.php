...
class OsticketConfig extends Config {
	...
	// Strobe Technologies Ltd | 20/08/2015 | END - Checking to see if Time Spent parts are enabled
	...
	// Strobe Technologies Ltd | 20/08/2015 | END - Update Time Settings Function
